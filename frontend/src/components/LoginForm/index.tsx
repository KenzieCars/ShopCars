...
import { ButtonContainer, ButtonToRegister, FieldsetLogin, ForgotMyPassword, FormLoginContainer, MainContainerLogin, TitleLogin, Error } from "./style"
  ...
  return (
    <MainContainerLogin>
      <FormLoginContainer onSubmit={handleSubmit(submit)}>
        ...
        <FieldsetLogin>
          <label>Email</label>
          <input type="email" placeholder='johndoe@mail.com' {...register('email')} /> 
